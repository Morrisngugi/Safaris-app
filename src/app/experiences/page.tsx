...
export const metadata: Metadata = pageMetadata({
  title: "Kenya Safari Experiences | Ivory Atlas",
  description:
    "From luxury wildlife safaris and family adventures to romantic escapes and beach-and-safari combinations, discover the travel experiences Ivory Atlas can shape for you.",
  path: "/experiences",
